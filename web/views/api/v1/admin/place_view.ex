defmodule Playdays.Api.V1.Admin.PlaceView do
  use Playdays.Web, :view

  alias Playdays.Api.V1.Admin.CategoryView
  alias Playdays.Api.V1.Admin.TagView
  alias Playdays.Api.V1.Admin.DistrictView

  @json_attrs ~W(id name website_url contact_number location_address description image is_active lat long is_featured)a
